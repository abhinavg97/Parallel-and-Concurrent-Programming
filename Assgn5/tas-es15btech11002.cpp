...
void process()
{
	...
	fd = fopen (string("TASLock.log").c_str(),"w+");
	...
	cout<<"The average time taken by " << n << " threads to enter CS using TAS lock mechanism is " << totalTime/(n*k) << "ms" << endl;
	cout<<"The worst-case time taken by a thread to enter CS using TAS lock mechanism is " << WorstTime << "ms" << endl;
